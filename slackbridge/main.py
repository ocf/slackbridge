...
def main():
    ...
    results = slack_api(sc, 'conversations.list', exclude_archived=True, types="public_channel,private_channel")
    ...
    for channel in slack_channels:
        ...
        # except for private channels with no 'num_members' property
